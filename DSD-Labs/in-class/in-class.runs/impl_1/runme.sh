...
HD_PWD='C:/Users/coope/Documents/MSU-ECE-DSD/in-class/in-class.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log in_class.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source in_class.tcl -notrace
