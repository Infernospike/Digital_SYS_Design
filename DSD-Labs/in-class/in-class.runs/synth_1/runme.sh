...
HD_PWD='C:/Users/coope/Documents/MSU-ECE-DSD/in-class/in-class.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log in_class.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source in_class.tcl
