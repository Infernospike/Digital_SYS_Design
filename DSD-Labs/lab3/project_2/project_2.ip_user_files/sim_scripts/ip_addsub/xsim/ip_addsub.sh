...
#
# Script generated by Vivado on Wed Feb 07 19:52:06 -0600 2024
...
#
# Usage        : ip_addsub.sh
#                ip_addsub.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ip_addsub.sh [-reset_run]
#                ip_addsub.sh [-reset_log]
#                ip_addsub.sh [-help]
#
...
# script info
echo -e "ip_addsub.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ip_addsub.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_11 -L c_reg_fd_v12_0_7 -L xbip_dsp48_wrapper_v3_0_5 -L xbip_pipe_v3_0_7 -L xbip_dsp48_addsub_v3_0_7 -L xbip_addsub_v3_0_7 -L c_addsub_v12_0_16 -L xil_defaultlib -L secureip -L xpm --snapshot ip_addsub xil_defaultlib.ip_addsub -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ip_addsub.wdb xsim.dir libdpi.so)
...
Usage: ip_addsub.sh [-step]\n\
Usage: ip_addsub.sh [-lib_map_path]\n\
Usage: ip_addsub.sh [-reset_run]\n\
Usage: ip_addsub.sh [-reset_log]\n\
Usage: ip_addsub.sh [-keep_index]\n\
